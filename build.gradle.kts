...
// managed-integrity-v1: L7MSGUqH4Lk
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-ghostscript", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-ghostscript")
        description.set("kotlin-ghostscript")
        url.set("https://github.com/wabbit-corp/kotlin-ghostscript")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-ghostscript")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-ghostscript.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-ghostscript.git")
        }
    }
}
